...
| # | 決めること | なぜ本書で決めなかったか |
|---|-----------|---------------------|
| 1 | **要確認の行を残して確定した案件が、営業担当からどう見えるか。** KPI7 の段階では「確定済み」としか出ないが、実際には顧客の返事待ちが残っている。顧客と話すのは高橋なので、ユーザーゴール5（顧客に回答の見込みを伝えられる）から考えると、返事待ちが残っていることが見えたほうが自然 | 処理状況の表示を何段階にするかは、画面の機能として決める話であるため |
| 2 | **ステップ4でまとめた問い合わせを顧客に送るのは、中村か高橋か** | 送信そのものを今回の対象に含めるかどうかと合わせて決める必要があるため |
| 3 | **預かった文書の保管場所・閲覧できる範囲・保持期間**（前提・制約3） | 非機能要件として定義するため |
| 4 | **営業担当がスマートフォンから処理状況を見られる必要があるか**（ペルソナ2の利用状況） | 対応端末は非機能要件として判断するため |
